...
def test_multicca_permute():
    ...
    res = sparsecca.multicca_permute(datasets, penalties=np.sqrt(3)/2)
    pprint(res)
...
def test_compare_multicca_permute_to_r():
    ...
    cors = np.array([
        0.4986115, 0.4986115, 0.4986115, 0.4986115, 0.4986115, 0.4948202, 0.4809967, 0.4865116, 0.4821666, 0.4748496
    ])
    penalties = np.array([
    ...
    zstat = np.array([
        0.467956119157931, 0.467956119157931, 0.467956119157931, 0.467956119157931, 0.467956119157931, 0.365482477335275, 0.0579137832284457, -
        0.0553037219023547, -0.120807884563517, -0.190823297491557
    ])
